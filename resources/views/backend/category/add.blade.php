                ...
                <div class="col-12 col-sm-12 col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('category.store') }}" class="form-horizontal demo-form" id="postform" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="file" name="image" id="image" class="form-control @if($errors->has('image')){{'error_scroll'}} @endif" value="{{ old('image') }}" >
                                            @if ($errors->has('image'))
