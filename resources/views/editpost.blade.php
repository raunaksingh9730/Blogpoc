                ...
                <div class="col-12 col-sm-12 col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('post.update',$data->id) }}" class="form-horizontal demo-form" id="postform" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="file" name="thumb" id="thumb" class="form-control @if($errors->has('thumb')){{'error_scroll'}} @endif" value="{{ $data->thumb }}" >
                                            @if ($errors->has('thumb'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="file" name="full_img" id="full_img" class="form-control @if($errors->has('full_img')){{'error_scroll'}} @endif" value="{{ $data->full_img }}" >
                                            @if ($errors->has('full_img'))
                                            <div class=" text-danger">{{ $errors->first('full_img') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea type="text" name="tags" id="tags" class="form-control @if($errors->has('tags')){{'error_scroll'}} @endif">{{$data->tags}}</textarea>
                                            @if ($errors->has('tags'))
